...
1. HTTP and HTTPS listeners with default actions:
...
2. HTTP to HTTPS redirect and HTTPS cognito authentication:
...
3. Cognito Authentication only on certain routes, with redirects for other routes:
